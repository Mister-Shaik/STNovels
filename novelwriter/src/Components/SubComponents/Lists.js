    ...
    render() {
        ...
        if(this.props.name === "Trackers")
        {
            ...
            final = values.map(vals => (
                <div>
                    <h5 className="mt0 pl3 pa2 shadow-5" style={{backgroundColor:"#08d9d6",color:"#252a34",whiteSpace:"nowrap"}} onClick={() => {let temp = this.state.states; temp[vals] = !temp[vals]; this.setState({states : temp})}}>- {vals}</h5>
